...
#define Criteria     0.02   // all training outputs must be within this for training to stop
#define TestCriteria 0.05     // all testing outputs must be within this for generalization

#define LearningRate 0.01     // most books suggest 0.3 as a starting point
...
#define MaxIterate   90000000 // maximum number of iterations before giving up training
#define ReportIntv   150001    // print report every time this many training cases done

// network topology ----------------------------------------------
#define NumNodes1    4       // col 1 - must equal NumINs+1 (extra node is bias node)
#define NumNodes2    20      // col 2 - hidden layer 1, etc.
#define NumNodes3    20       // output layer is last non-zero layer, and must equal NumOUTs
...
#define NumOfCols    4       // number of non-zero layers specified above, including the input layer
#define NumOfRows    20      // largest layer - i.e., max number of rows in the network

// data files -----------------------------------------------
#define TrainFile    "TrainingSet_Median.txt"  // file containing training data
#define TestFile     "TestingSet_Median.txt"  // file containing testing data 
#define TrainCases   45           // number of training cases
#define TestCases    45            // number of test cases
